    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/cidades", "/api/cidades/**").hasRole("SUPER_ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/cidades", "/api/cidades/**").hasRole("SUPER_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/cidades", "/api/cidades/**").hasRole("SUPER_ADMIN")
